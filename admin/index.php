  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <li><a href="index.php?page=update_password"><span class="glyphicon glyphicon-user"></span> Update Password</a></li>
       ...
       <li><a href="https://mail.google.com"><span class="glyphicon glyphicon-mail"><span class="glyphicon glyphicon-envelope"></span> Admin Mail </a></li>
       
       <li><a href="report.php"><span class="glyphicon glyphicon-chart"></span> Chart </a></li>
